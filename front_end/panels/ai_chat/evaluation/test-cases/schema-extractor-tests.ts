 ...
 */
export const wikipediaTest: TestCase<SchemaExtractionArgs> = {
...
export const googleFlightsTest: TestCase<SchemaExtractionArgs> = {
  ...
  url: 'https://www.google.com/travel/flights/search?tfs=CBwQAhopag0IAhIJL20vMDJfMjg2EgoyMDI1LTAzLTE1cgwIAxIIL20vMDFmNjJAAUgBcAGCAQsI____________AZgBAg&tfu=EgYIAhAAGAA',
  tool: 'extract_schema_data',
  input: {
    schema: {
      type: 'object',
...
/**
 * All test cases for SchemaBasedExtractorTool
 */
 ...
 */
export function getTestById(id: string): TestCase<SchemaExtractionArgs> | undefined {
  return schemaExtractorTests.find(test => test.id === id);
}

/**
 * Get tests by tag
 */
export function getTestsByTag(tag: string): TestCase<SchemaExtractionArgs>[] {
